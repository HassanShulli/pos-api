...
This is fork from mongoose-paginate and retuen 0 index for page which will be use in Angular
## Installation

```sh
npm install mongoose-paginate-page
...
* `[page]` {Number} - Only if specified or default `page`/`offset` values were used , result start from 0 
